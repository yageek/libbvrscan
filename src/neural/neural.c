...
{
    bvr_matf64_t *entry = bvr_matf64_new( entry_vector_size,1);
    bvr_matf64_t *hidden = bvr_matf64_new( hidden_layer_size,entry_vector_size);
    bvr_matf64_t *output_layer = bvr_matf64_new( hidden_layer_size,entry_vector_size);
